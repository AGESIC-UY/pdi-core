...
if (( $# != 3 ))
then
  echo "Debe indicar en el siguiente orden, el directorio donde estan los paquetes, el host de la maquina destinto y el perfil que se esta construyendo (local, desa, qa, uat, prep, prod, test)"
  exit 1
fi
